...
namespace ivs_proj_2_calc
{
    ...
    public class MathHead
    {
        ...
        /// Ak je hodnota "y" (delite¾) rovný nule, vyhodí výnimku "DivideByZero".
        /// </summary>
        ...
        /// Ak je výsledkom nekoneèno alebo "NaN", vyhodí výnimku "NotFiniteNumber".
        /// </summary>
        ...
        /// Ak je parameter rovný 0 alebo 1, výsledkom je hodnota 1. Využíva rekurziu.
        /// </summary>
        /// <param name="x">Hodnota, z ktorej chceme získa faktoriál</param>
        /// <returns>Vracia faktoriál z hodnoty "x" a vynásobí ho so znova zavolanou funkciou, kde sa hodnota "x" zníži o 1, až dokým nie je hodnota "x" rovná 1</returns>
        ...
        /// Ak je hodnota "n" rovná nule, vyhodí výnimku "DivideByZero".
        /// Ak je hodnota "x" záporná, vyhodí výnimku "NotFiniteNumber", pretože "n"-tá odmocnina zo záporného èísla sa nedá vyjadri.
        /// </summary>
        ...
        /// </summary>
        /// <param name="x">Hodnota, ktorú chceme znegovat (obrátit znamienko)</param>
